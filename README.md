...
package's example tour — Storage listing, streaming callables, Remote Config's
update listener, Firestore's offline persistence and bundles, and the
Database's exclusive cursors.
